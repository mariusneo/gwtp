...
public class AdministrationPresenter extends
    Presenter<AdministrationPresenter.MyView, AdministrationPresenter.MyProxy> {
  /**
   * {@link AdministrationPresenter}'s proxy.
   */
  @ProxyCodeSplit
  @NameToken(NameTokens.administrationPage)
  @UseGatekeeper(IsAdminGatekeeper.class)
  public interface MyProxy extends ProxyPlace<AdministrationPresenter> {
  }

  /**
   * {@link AdministrationPresenter}'s view.
   */
  public interface MyView extends View {
  }

  @Inject
  public AdministrationPresenter(final EventBus eventBus, final MyView view,
      final MyProxy proxy) {
