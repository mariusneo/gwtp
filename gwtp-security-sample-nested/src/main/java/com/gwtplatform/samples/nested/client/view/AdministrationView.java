...
import com.gwtplatform.samples.nested.client.presenter.AdministrationPresenter.MyView;

/**
 * @author Christian Goudreau
 */
public class AdministrationView extends ViewImpl implements MyView {
